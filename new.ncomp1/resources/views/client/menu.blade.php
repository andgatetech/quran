...
<body>
  <div class="container">
    ...
    <div class="button-group">
      ...
      <button class="btn" onclick="window.location.href='{{ route('competition.announce') }}'">Announce Competition</button>
      <button class="btn" onclick="window.location.href='{{ route('registrations.index') }}'">Registration Requests</button>
