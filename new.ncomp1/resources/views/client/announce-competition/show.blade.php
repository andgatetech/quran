    ...
    <div class="container1">
        <div class="tabs">
            ...
            <button class="tab-btn "
                onclick="window.location.href='{{ route('competition.announce') }}'">Deadline of this Competition is :</button>
            <button class="tab-btn " onclick="window.location.href='{{ route('announce-list.index') }}'">{{ Carbon\Carbon::parse($competition->end_date)->format('d-m-Y H:i')}}
            </button>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 offset-md-3">
                <h6 class="heading col-12 py-3 my-3">FIll the below from in English Language</h6>
                <div class="form-container px-0">
                    ...
                    <form class="competition-form" method="POST" action="{{ route('competition.apply') }}" enctype="multipart/form-data">
                        ...
                        <input type="text" value="{{ old('name') }}" class="form-control" id="name" name="name" placeholder="Participant Name" required>
                        ...
                        <input type="date" value="{{ old('dob') }}" class="form-control text-muted" id="dob" name="dob" placeholder="Date of Birth" required>
                        <input type="number" value="{{ old('age') }}" class="form-control" id="age" name="age" placeholder="Age" required readonly>
                        <input type="text"  value="{{ old('organization') }}"  id="organization"  name="organization" placeholder="Organization" required>
                        <input type="text" value="{{ old('parent_name') }}"  id="parent_name"  name="parent_name" placeholder="If Parent (Parent name)">
                        <input type="text" value="{{ old('number') }}"  id="number"  name="number" placeholder="Contact Number" required>
