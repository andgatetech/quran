    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 offset-md-3">
                ...
                @endif
                    <form class="competition-form" method="POST" action="{{ isset($competition)? route('announce-list.update',$competition->id) : route('announce-list.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-3">
                                <input type="date" value="{{ isset($competition) ? $competition->start_date : '' }}" class="form-control" id="start_date" name="start_date" placeholder="From Date" required>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <input type="date" value="{{ isset($competition) ? $competition->end_date : '' }}" class="form-control" id="end_date" name="end_date" placeholder="To Date" required>
                            </div>
                        </div>
