            ...
            @forelse($competitors as $competitor)
                <div class="list-item mb-3 p-3 border rounded" onclick="this.classList.toggle('active')">
                    ...
                    <div class="details mt-2" style="display: none;     box-shadow:0 !important;">
                        ...
                        <p><strong>Competition Name:</strong> {{ $competitor->competition->main_name }}</p>
                        <p><strong>Side Category:</strong> {{ $competitor->sideCategory->name }}</p>
                        <p><strong>Read Category:</strong> {{ $competitor->readCategory->name  }}</p>
                        <p><strong>Age Category:</strong> {{ $competitor->ageCategory->name  }}</p>
