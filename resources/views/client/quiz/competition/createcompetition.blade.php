...
@include('client.layouts.top-bar')
    ...
    <div class="container1">
        ...
        <button class="tab-btn active " onclick="window.location.href='{{ route('quiz.competition.create') }}'">Create
            Competition</button>
          <button class="tab-btn " onclick="window.location.href='{{ route('quiz.competition.list') }}'">Competition
            List</button>
        </div>
    </div>
    <div class="container">
        ...
        <div class="form-container">
          <form class="competition-form" method="POST" action="{{ route('quiz.competition.store') }}">
            @csrf
            @php
