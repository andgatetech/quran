...
.btn-complete,
    ...
    <div class="button-group1">
        ...
        <a href="{{ route('poetry.competitions.list') }}" class="btn  active-button">Competitions</a>
        <a href="{{ route('poetry.host.announce') }}" class="btn  ">Announce Winners</a>
    </div>
    <div class="container">
            ...
            <div class="list-item mb-3 p-3 border rounded" onclick="this.classList.toggle('active')">
                ...
                <div class="details">
                    ...
                    <div class="button-group-inline">
                        <form action="{{ route('poetry.host.continue', $host->id) }}" method="POST">
                            @csrf
