...
<body>
    ...
    <div class="button-group1">
        <a href="{{ route('poetry.host.create') }}" class="btn btn-outline-success active-button">Host Competition</a>
        <a href="{{ route('poetry.competitions.list') }}" class="btn btn-outline-success ">Competitions</a>
        <a href="{{ route('poetry.host.announce') }}" class="btn btn-outline-success">Announce Winners</a>
    </div>
    ...
    <div class="container">
            ...
            <div class="form-container">
                ...
                @endif
                <form action="{{ route('poetry.host.store') }}" method="POST">
                    @csrf
