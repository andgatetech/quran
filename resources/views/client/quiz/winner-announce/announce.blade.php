...
.button-group1 a:hover{background-color: var(--secondary-color) !important;
    ...
    <header class="header">
        <a class="back-btn" href="{{ route('client.menu.quiz') }}"><i class="fas fa-home"></i></a>
         Announce Winners(Quiz)
    </header>

    <div class="button-group1">
        <a href="{{ route('quiz.winner.announce') }}" class="btn  active-button">Announce</a>
        <a href="{{ route('quiz.winner.announce') }}" class="btn" style="width:125px; !important;">Announceed</a>
    </div>
    ...
    <div class="button-group1" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius:1rem;padding:.5rem; border:1px solid  var(--secondary-color);">
        ...
        <select id="ageCategoryFilter" class="btn ">
            ...
            <option value="Rejected">Incorrect/Rejected</option>     
        </select>
        ...
        <a href="{{ route('quiz.winner.announce') }}" class="btn  active-button">Generate</a>
    </div>
    <div class="container">
...
<form action="{{ route('poetry.rank.create', $competitor->id) }}" method="POST">
    @csrf
    ...
    <div class="question-card"
        ...
        <div class="question-details">
            ...
            <p><strong>Competition Name :</strong> <span>{{ $competitor->competition->main_name ?? 'N/A' }}</span></p>
