    ...
    <div class="container1">
        ...
        <form action="{{ route('report.index') }}" method="get">
            ...
            <div class="row my-3">
                <div class="col-6">
                    <select class="form-select" name="side_category" id="side_category">
                        <option value="">Questions Option</option>
            ...
            <div class="row my-3">
                ...
                <div class="col-6">
                    <select class="form-select" name="read_category" id="read_category">
                        <option value="">Host Status</option>
                        <option value="Correct">Correct/Approve</option>
                        <option value="Rejected">In Correct/Rejected</option>
            ...
            <div class="col-md-6 offset-md-3 col-sm-12">
                    ...
                    <div class="competition-card">
                        ...
                        <div class="competition-sub-name">
                            ...
                            <p>Question Type : <span></span></p>
                            <p>Host Status : <span></span></p>
                            <p>Place : <span></span></p>
                            <p>From Date-To Date : <span></span></p>
