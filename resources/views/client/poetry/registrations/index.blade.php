...
<body>
    ...
    <header class="header">
        ...
        <h1>Competition Application List</h1>
    </header>

    <div class="container1">
        <div class="tabs">
            <button class="tab-btn {{ $status == 'Pending' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.competition.applicant.list', 'status=Pending') }}'"> &nbsp;&nbsp;Pending &nbsp;&nbsp;</button>
            <button class="tab-btn px-2 {{ $status == 'Approved' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.competition.applicant.list', 'status=Approved') }}'"> &nbsp;&nbsp; Approved  &nbsp;&nbsp;</button>
            <button class="tab-btn px-2 {{ $status == 'Un-Approved' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.competition.applicant.list', 'status=Un-Approved') }}'">Un
                Approved</button>

        </div>
        <form action="{{ route('poetry.competition.applicant.list') }}" method="get">
            <div class="row">
                @if ($errors->any())
                    ...
                    <div class="competition-card">
                        ...
                        <div class="competition-sub-name">
                         ...
                         <!--   <p class="pt-3 pb-2">Number of Questions:</p>-->
                            ...
                            <div>
                                @if($status == 'Pending')
                                    <form action="{{ route('poetry.competition.applicant.status.update') }}" method="POST"
