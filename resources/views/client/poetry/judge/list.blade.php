...
@section('content')
    ...
    <header class="header">
        ...
        <h1>Judge List(Poetry)</h1>
      </header>


        <div class="tabs">
            <button class="tab-btn" onclick="window.location.href='{{ route('poetry.judges.create') }}'">Create Judge</button>
            <button class="tab-btn active" onclick="window.location.href='{{ route('poetry.judges.index') }}'">Judge List</button>
        </div>
                ...
                <div class="category-card">
                    ...
                    <div class="details">
                        ...
                        <div class="button-group-inline">
                            <form action="{{ route('poetry.judges.destroy', $judge->id) }}" method="POST"
                                style="display:inline-block;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn delete-btn">Delete</button>
                            </form>
                            <a href="{{ route('poetry.judges.edit', $judge->id) }}" class="btn edit-btn">Edit</a>
                        </div>
                    </div>
                </div>
            @empty
