...
@section('content')
    <header class="header">
        ...
        <h1>Edit Judge(Poetry)</h1>
    </header>

    <div class="tabs">

        <button class="tab-btn active" onclick="window.location.href='{{ route('poetry.judges.create') }}'">Create Judge</button>
        <button class="tab-btn " onclick="window.location.href='{{ route('poetry.judges.index') }}'">Judge List</button>
    </div>
    <div class="container my-5">
        ...
        <div class="button-group mb-4">
            <a href="{{ route('poetry.judges.create') }}" class="btn btn-outline-success">Create Judge</a>
            <a href="{{ route('poetry.judges.index') }}" class="btn btn-outline-success active-button">Judge List</a>
        </div>
        -->
        ...
        <!-- The Form -->
        <form action="{{ route('poetry.judges.update', $judge->id) }}" method="POST" class="form-container mt-4">
            @csrf
            @method('PUT')
