...
<header class="header">
    ...
    <h1>Create Competitor(Poetry)</h1>
  </header>

  <div class="container1">
<div class="tabs">

<button class="tab-btn active"  onclick="window.location.href='{{ route('poetry.competitors.create') }}'">Create Competitor</button>
<button class="tab-btn " onclick="window.location.href='{{ route('poetry.competitors.index') }}'">Competitor List</button>
</div>
  </div>
    ...
    <div class="container my-5">
        ...
        <!-- The Form -->
        <form action="{{ route('poetry.competitors.store') }}" method="POST" class="form-container" style="margin: 0 !important;">
            @csrf
