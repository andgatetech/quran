...
<button class="tab-btn "  onclick="window.location.href='{{ route('poetry.competitors.create') }}'">Create Competitor</button>
<button class="tab-btn " onclick="window.location.href='{{ route('poetry.competitors.index') }}'">Competitor List</button>
    ...
    <div class="container my-5">
        ...
        <!-- The Form -->
        <form action="{{ route('poetry.competitors.update', $competitor->id) }}" method="POST" class="form-container mt-4">
            @csrf
            @method('PUT')
