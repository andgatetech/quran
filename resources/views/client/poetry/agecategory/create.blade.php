...
<body>
  ...
  <header class="header">
    ...
    <h1>Create Age Category(Poetry)</h1>
  </header>

    <div class="tabs">
    <button class="tab-btn active"  onclick="window.location.href='{{ route('poetry.agecategory.create') }}'">Create Age Category</button>
    <button class="tab-btn " onclick="window.location.href='{{ route('poetry.agecategory.index') }}'">Age Category List</button>
    </div>
  ...
  <div class="container">
    ...
    <div class="form-container">
      ...
      <!-- Age Category Form -->
      <form method="POST" action="{{ route('poetry.agecategory.store') }}" class="age-category-form">
        @csrf
