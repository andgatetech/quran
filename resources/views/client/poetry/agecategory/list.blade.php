...
<body>
    <header class="header">
        ...
        <div class="tabs">
        <button class="tab-btn "  onclick="window.location.href='{{ route('poetry.agecategory.create') }}'">Create Age Category</button>
        <button class="tab-btn active" onclick="window.location.href='{{ route('poetry.agecategory.index') }}'">Age Category List</button>
        </div>
