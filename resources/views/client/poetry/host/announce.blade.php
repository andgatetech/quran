...
.button-group1 a:hover{background-color: var(--secondary-color) !important;
    ...
    <header class="header">
        <a class="back-btn" href="{{ route('client.menu.poetry') }}"><i class="fas fa-home"></i></a>
         Announce Winners(Poetry)
    </header>
    <div class="button-group1">
        <a href="{{ route('poetry.host.create') }}" class="btn  ">Host Competition</a>
        <a href="{{ route('poetry.competitions.list') }}" class="btn  ">Competitions</a>
        <a href="{{ route('poetry.host.announce') }}" class="btn  active-button">Announce Winners</a>
    </div>
