...
<div class="tabs">
    ...
    <div class="nav-buttons">
        ...
        <button class="nav-btn" onclick="window.location.href='{{ route('poetry.managenertificate.index') }}'">Settings List</button>
        <button class="nav-btn active" onclick="window.location.href='{{ route('poetry.managenertificate.generate.view') }}'">Generate</button>
...
<div class="container my-5">
    ...
    <form action="{{ route('poetry.managenertificate.generate.view') }}" method="get" style="margin-top: 1rem;">
                            @csrf
        <!-- Competition Filter -->
        ...
        <div class="generate_certificate_search">
            <label for="side_category" style="font-weight: bold; margin-right: 10px;">Perform Option:</label>
            <select name="side_category_filter" id="side_category" class="form-control" style="width: 300px; display: inline-block;">
                <option value="">Select Peform Option</option>
        ...
        <div class="generate_certificate_search">
            <label for="read_category" style="font-weight: bold; margin-right: 10px;">Method Of Perform:</label>
            ...
            <div class="list-item mb-3 p-4 border rounded shadow-sm" style="background-color: #fff; cursor: pointer; transition: transform 0.3s ease-in-out;" data-competition-id="{{ $competitor->competition_id }}">
                ...
                <div class="details mt-2" style="margin-top: 1rem; color: #555; background-color: #f9f9f9; padding: 1rem; border-radius: 5px; max-height: 0; overflow: hidden; transition: max-height 0.3s ease-in-out;">
                    ...
                    <div style="margin-bottom: 1rem; padding: 1rem; border-bottom: 1px solid #ddd;">
                        ...
                        <form action="{{ route('poetry.certificate.generate') }}" method="post" style="margin-top: 1rem;">
                            @csrf
