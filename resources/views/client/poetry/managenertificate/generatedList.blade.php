...
<div class="tabs">
    ...
    <div class="nav-buttons">
        ...
        <button class="nav-btn active" onclick="window.location.href='{{ route('poetry.managenertificate.generated.list') }}'">Generated List</button>
    </div>
</div>
...
<div class="container my-5">
    ...
    <form action="{{ route('poetry.managenertificate.generated.list') }}" method="get" style="margin-top: 1rem;">
                            @csrf
        <!-- Competition Filter -->
