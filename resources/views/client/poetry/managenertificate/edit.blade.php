...
@section('content')
<header class="header">
    <a class="back-btn" href="{{ route('poetry.managenertificate.index') }}"><i class="fas fa-home"></i></a>
    <h1>Edit Certificate(Poetry)</h1>
</header>

<div class="container">
    <form action="{{ route('poetry.managenertificate.update', $certificate->id) }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        @method('PUT')
