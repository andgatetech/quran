...
<div class="nav-buttons">
        <button class="nav-btn active" onclick="window.location.href='{{ route('poetry.managenertificate.create') }}'">Certificate Settings</button>
...
<div class="container">
    ...
    <form style="padding: 10px;" action="{{ route('poetry.managenertificate.store') }}" method="POST" enctype="multipart/form-data" class="d-block">
        @csrf
