...
@include('client.layouts.top-bar')
    ...
    <div class="container1">
        <div class="tabs">
        <button class="tab-btn active " onclick="window.location.href='{{ route('poetry.competition.create') }}'">Create
            Competition</button>
          <button class="tab-btn " onclick="window.location.href='{{ route('poetry.competition.list') }}'">Competition
            List</button>
        </div>
    </div>
    <div class="container">
