...
@include('client.layouts.top-bar')
    ...
    <div class="container1">
        <div class="tabs">
        <button class="tab-btn" onclick="window.location.href='{{ route('poetry.competition.create') }}'">Create Competition</button>
        <button class="tab-btn active" onclick="window.location.href='{{ route('poetry.competition.list') }}'">Competition List</button>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 offset-md-3">
              ...
              <div class="form-container">
                  <form class="competition-form" method="POST" action="{{ route('poetry.competition.update', $competition->id) }}">
                      @csrf
                      @method('PUT')
