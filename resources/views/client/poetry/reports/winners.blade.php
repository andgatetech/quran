    ...
    <div class="container1">
        <div class="tabs">
            <button class="tab-btn {{ $status == 'Participants' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.report', 'status=Participants') }}'"> &nbsp;&nbsp;Participants &nbsp;&nbsp;</button>
            <button class="tab-btn px-2 {{ $status == 'Sponsers' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.report', 'status=Sponsers') }}'"> &nbsp;&nbsp; Sponsers  &nbsp;&nbsp;</button>
            <button class="tab-btn px-2 {{ $status == 'Winners' ? 'active' : ''  }}"
                onclick="window.location.href='{{ route('poetry.report', 'status=Winners') }}'">Winners</button>
            ...
            <div class="col-md-6 offset-md-3 col-sm-12">
                    ...
                    <div class="competition-card">
                        ...
                        <div class="competition-sub-name">
                            ...
                            <p>Perform Option : <span></span></p>
                            <p>Method Of Perform : <span></span></p>
                            <p>Date of Host:<span></span></p>
                            <p>Complete Date : <span></span></p>
                            <p>Place : <span></span></p>
