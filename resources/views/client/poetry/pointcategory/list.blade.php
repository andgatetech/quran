...
<header class="header">
    ...
    <h1>Point Category List(Poetry)</h1>
</header>
    <div class="tabs">
        <button class="tab-btn" onclick="window.location.href='{{ route('poetry.pointcategory.create') }}'">Create Point Category</button>
        <button class="tab-btn active" onclick="window.location.href='{{ route('poetry.pointcategory.list') }}'">Point Category List</button>
    </div>
