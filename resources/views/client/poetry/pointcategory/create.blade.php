...
<body>
    ...
    <header class="header">
        ...
        <h1>Create Point Category(Poetry)</h1>
    </header>

      <div class="container1">
  <div class="tabs">
    <button class="tab-btn active"  onclick="window.location.href='{{ route('poetry.pointcategory.create') }}'">Create Point Category</button>
    <button class="tab-btn " onclick="window.location.href='{{ route('poetry.pointcategory.list') }}'">Point Category List</button>
  </div>
      </div>
    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('poetry.pointcategory.store') }}">
                    @csrf
