...
@section('content')
    ...
    <div class="container1">
        <div class="tabs">
            <button class="tab-btn active" onclick="window.location.href='{{ route('quran.competitor.create') }}'">Create
                Competitor</button>
            <button class="tab-btn" onclick="window.location.href='{{ route('quran.competitor.list') }}'">Competitor
                List</button>
        </div>
    </div>
        ...
        <div class="container my-5">
            ...
            <!-- The Form -->
            <form action="{{ route('quran.competitor.store') }}" method="POST" class="form-container" style="margin: 0 !important;">
                @csrf
            ...
            <form action="{{ route('quran.competitor.bulkStore') }}" method="POST" enctype="multipart/form-data" class="form-container mt-4">
                @csrf
                <div class="form-group mb-3">
