...
@include('client.layouts.top-bar')
    ...
    <div class="container1">
        <div class="tabs">
        <button class="tab-btn active"  onclick="window.location.href='{{ route('quran.agecategory.create') }}'">Create Age Category</button>
        <button class="tab-btn " onclick="window.location.href='{{ route('quran.agecategory.index') }}'">Age Category List</button>
        </div>
    </div>
    <div class="container">
        <div class="row">
      ...
      @endif
          ...
          <form class="recitation-piece-form" method="POST" action="{{ route('quran.agecategory.store') }}">
        @csrf
