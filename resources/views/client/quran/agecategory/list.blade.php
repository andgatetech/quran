...
@include('client.layouts.top-bar')
    ...
    <div class="tabs">
    <button class="tab-btn "  onclick="window.location.href='{{ route('quran.agecategory.create') }}'">Create Age Category</button>
    <button class="tab-btn active" onclick="window.location.href='{{ route('quran.agecategory.index') }}'">Age Category List</button>
    </div>
        ...
        @foreach($ageCategories as $ageCategory)
          <div class="category-card">
            <div class="card-header" onclick="toggleDropdown(this)">
              <p>Age Category: <span>{{ $ageCategory->name }}</span> <i class="fas fa-chevron-down"></i></p>
            </div>
            <div class="card-actions">
              <form action="{{ route('quran.agecategory.delete', $ageCategory->id) }}" method="POST" style="display:inline-block;">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn delete-btn">Delete</button>
              </form>
                <a href="{{ route('quran.agecategory.edit',$ageCategory->id) }}" class="btn edit-btn">Edit</a>
            </div>
          </div>
        @endforeach
