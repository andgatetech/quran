...
@include('client.layouts.top-bar')
    ...
    <div class="container">
      ...
      @endif
          ...
          <form class="recitation-piece-form" method="POST" action="{{ route('quran.recitation.piece.update', $recitationPiece->id) }}">
            @csrf
            @method('put')
            <input type="text" name="name" id="name" value="{{ $recitationPiece->name }}" required>
