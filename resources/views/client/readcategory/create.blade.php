...
<body>
  ...
  <div class="tabs">
    <button class="tab-btn active"  onclick="window.location.href='{{ route('readcategory.create') }}'">Create Read Category</button>
...
.container {
  ...
  padding-bottom: 150px; /* Add space at the bottom for footer */
}
