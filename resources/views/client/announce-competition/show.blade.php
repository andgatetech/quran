...
<body>
    ...
    <div class="container1">
        <p>Deadline of this Competition is : <span style="font-weight: 700;">  {{$competition->end_date}}</span> </p>
        ...
        <div class="tabs">
                ...
                onclick="window.location.href='{{ route('competition.announce') }}'">Fill out the form
           </button>
