...
class QuranJudgeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('client.quran.judge.list', compact('judges'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('quran.judges.list')->with('success', 'Judge created successfully!');
        } catch (\Exception $e) {
            // Log the error
    ...
    public function edit($id)
    {
        ...
        return view('client.quran.judge.edit', compact('judge','pointCategories','competitions'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('quran.judges.list')->with('success', 'Judge updated successfully!');
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            ...
            // Redirect to judge list with success message
            return redirect()->route('quran.judges.list')->with('success', 'Judge deleted successfully!');
        } catch (\Exception $e) {
            \Log::error('Error deleting judge: ' . $e->getMessage());
            return redirect()->route('quran.judges.list')->with('error', 'Failed to delete judge. Please try again.');
        }
    }
