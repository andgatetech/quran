...
class QuizCompetitionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('client.quiz.competition.createcompetition', compact('moduleName')); // Path to your Blade file
    }
    ...
    public function edit($competitionId)
    {
        ...
        return view('client.quiz.competition.editcompetition', compact('moduleName','competition'));
    }
    ...
    public function index()
    {
        ...
        return view('client.quiz.competition.competitionlist', compact('moduleName','competitions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('quiz.competition.list')->with('success', 'Competition created successfully!');
    }
    ...
    public function update($competitionId, Request $request)
    {
        ...
        if (!$competitionId) {
            return redirect()->route('quiz.competition.list')->with('error', 'No competition selected for updating.');
        }
        ...
        if (!$competition) {
            return redirect()->route('quiz.competition.list')->with('error', 'Unauthorized access or competition not found.');
        }
        ...
        return redirect()->route('quiz.competition.list')->with('success', 'Competition updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('quiz.competition.list')->with('success', 'Competition deleted successfully!');
    }
}
