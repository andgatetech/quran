...
class QuizWinnerAnnounceController extends Controller
{
...
->get();
return view('client.poetry.winning-announcement.index', compact('competitors','competition'));
    ...
    public function announceWinners()
{
   ...
   $competitors = Competitor::with(['sideCategory', 'readCategory', 'ageCategory', 'results' ])
    ...
    return view('client.quiz.winner-announce.announce', compact('sortedCompetitors', 'competition_id', 'sideCategories', 'readCategories', 'ageCategories'));
}
