...
class PoetryHostController extends Controller
{
    public function continue($id)
    {
        ...
        return redirect()->route('poetry.competitions.list')->with('success', 'Host status updated to done.');
    }
    ...
    public function competitionList()
    {
        ...
        return view('client.poetry.host.competition-list', compact('hosts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('poetry.host.create')->with('success', 'Competition hosted successfully');
    }
