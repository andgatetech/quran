...
class PoetryJudgeController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('client.poetry.judge.create', compact('competitions', 'pointCategories'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('poetry.judges.index')->with('success', 'Judge created successfully!');
        } catch (\Exception $e) {
            // Log the error
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('poetry.judges.index')->with('success', 'Judge updated successfully!');
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            ...
            // Redirect to judge list with success message
            return redirect()->route('poetry.judges.index')->with('success', 'Judge deleted successfully!');
        } catch (\Exception $e) {
            \Log::error('Error deleting judge: ' . $e->getMessage());
            return redirect()->route('poetry.judges.index')->with('error', 'Failed to delete judge. Please try again.');
        }
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        $judge = Judge::findOrFail($id);
        return view('client.poetry.judge.edit', compact('judge','pointCategories','competitions'));
    }
