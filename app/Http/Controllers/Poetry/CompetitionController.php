...
class CompetitionController extends Controller
{
    ...
    {
        return view('client.poetry.competition.createcompetition'); // Path to your Blade file
    }
    ...
    public function edit()
    {
        ...
        return view('client.poetry.competition.editcompetition', compact('competition'));
    }
    ...
    public function update(Request $request)
{
    ...
    $competition = PoetryCompetition::where('id', $competitionId)
