...
class PoetryManageCertificateController extends Controller
{
    public function create(){
        ...
        ->get();
        return view("client.poetry.managenertificate.create", compact("competitions"));
    }
    ...
    public function certificate_generate(Request $request)
    {
        ...
        $pdf = PDF::loadView('client.poetry.managenertificate.template', $validated)
...
if($search_competition_id !== null){
    ...
    return view('client.poetry.managenertificate.list', compact('certificates', 'competitions', 'search_competition_id'));
}
...
public function update(Request $request, $id)
{
    ...
    // Redirect back with a success message
    return redirect()->route('poetry.managenertificate.index')->with('success', 'Certificate updated successfully.');
}
...
public function edit($id)
{
    ...
    return view('client.poetry.managenertificate.edit', compact('certificate', 'competitions'));
}
    ...
    public function generateView(Request $request)
    {
        ...
        return view('client.poetry.managenertificate.generateview', compact(
            'competitions',
            'sideCategories',
            'readCategories',
            'ageCategories',
...
public function generatedList(){
   ...
   return view('client.poetry.managenertificate.generatedList', compact(
       'competitions',
       'sideCategories',
       'readCategories',
       'ageCategories',
...
public function generatePDF(Request $request)
{
    ...
    // Generate the PDF
    $pdf = Pdf::loadView('client.poetry.managenertificate.certificateTemplate', $data)
              ->setPaper('a4', 'landscape');
